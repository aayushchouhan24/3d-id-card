  ...
  return (
    <Canvas dpr={[1, 2]} camera={{ position: [0, 0, 13], fov: 25 }}>
      ...
      <Environment background blur={0.75}>
        ...
        <Lightformer toneMapped intensity={5} color="white" position={[-10, 0, 14]} rotation={[0, Math.PI / 2, Math.PI / 3]} scale={[500, 10, 1]} />
        <Lightformer toneMapped intensity={3} color="white" position={[15, 0, 10]} scale={[10, 10, 1]} />
      </Environment>
    </Canvas>
  )
}
